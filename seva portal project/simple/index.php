            ...
            <div class="payment">
                <form>
                    ...
                    <div class="form-group owner">
                        ...
                        <input type="text" name="amount" value="120" class="form-control" id="owner" required="">
                    </div>
                    ...
                    <div class="form-group" id="pay-now">
                        <button type="submit" name="submit" id="submit" class="btn btn-default" style="height:50px">Submit</button>
                    </div>
                </form>
            </div>
        </div>
